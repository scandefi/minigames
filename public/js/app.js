...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  watch: {
    data: {
      immediate: true,
      deep: true,
      handler: function handler(val, oldVal) {//do something
      }
    }
  },
  computed: {},
  methods: {
    login: function login() {
      axios.post('/api/users/login-or-register', {
    ...
    authuser: function authuser() {
      axios.post('/api/authuser').then(function (response) {
        console.info(response.data);
      });
    },
    ...
    complaints: function complaints() {
      axios.get('https://scandefi.test/api/complaints').then(function (response) {
        console.info(response.data);
      });
    },
    bot: function bot() {
      axios.get('/api/bot').then(function (response) {
        console.info(response.data);
      });
    }
  },
...
var render = function() {
  ...
  return _c("section", { staticClass: "example-component" }, [
    _c(
      "button",
      {
    ...
    _c(
      "button",
      {
        ...
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.authuser.apply(null, arguments)
          }
        }
      },
      [_vm._v("AUTHUSER")]
    ...
    _c(
      "button",
      {
        ...
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.complaints.apply(null, arguments)
          }
        }
      },
      [_vm._v("COMPLAINTS")]
    ...
    _c(
      "button",
      {
        ...
        on: {
          click: function($event) {
            $event.preventDefault()
            return _vm.bot.apply(null, arguments)
          }
        }
      },
      [_vm._v("DETECT BOT")]
    ...
    _vm._v(" "),
    _c("div", {
      staticClass: "webgl-content",
      staticStyle: { width: "100vw", height: "100vh", "margin-top": "40px" }
    }),
    _vm._v(" "),
    _c("div", {
      staticStyle: { width: "100vw", height: "100vh", "margin-top": "40px" },
      attrs: { id: "unityContainer" }
    })
  ])
}
var staticRenderFns = []
